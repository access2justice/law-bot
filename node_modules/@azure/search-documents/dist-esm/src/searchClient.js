...
export class SearchClient {
    ...
    async searchDocuments(searchText, options = {}, nextPageParameters = {}) {
        const { searchFields, select, orderBy, includeTotalCount, vectorSearchOptions } = options, restOptions = __rest(options, ["searchFields", "select", "orderBy", "includeTotalCount", "vectorSearchOptions"]);
        const semanticSearchOptions = restOptions
            .semanticSearchOptions;
        delete restOptions.semanticSearchOptions;
        const _a = semanticSearchOptions !== null && semanticSearchOptions !== void 0 ? semanticSearchOptions : {}, { configurationName, errorMode, answers, captions } = _a, restSemanticOptions = __rest(_a, ["configurationName", "errorMode", "answers", "captions"]);
        const _b = vectorSearchOptions !== null && vectorSearchOptions !== void 0 ? vectorSearchOptions : {}, { queries, filterMode } = _b, restVectorOptions = __rest(_b, ["queries", "filterMode"]);
        ...
        try {
            ...
            const { results, nextLink, nextPageParameters: resultNextPageParameters, semanticPartialResponseReason: semanticErrorReason, semanticPartialResponseType: semanticSearchResultsType } = result, restResult = __rest(result, ["results", "nextLink", "nextPageParameters", "semanticPartialResponseReason", "semanticPartialResponseType"]);
